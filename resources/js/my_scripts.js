...
function loadStatsPage() {
    ...
    {
        //For loop traversing each row in the table
        var homeScore = parseInt(table.rows[rowCounter].cells[2].innerHTML);
        var oppScore = parseInt(table.rows[rowCounter].cells[3].innerHTML);
...
function loadPlayersPage() {
    ...
    {
        //creating anchor tag
        newText += '<a class = "dropdown-item" href = "#" onclick="switchPlayers(' + player_i + ')">' + players[player_i].name + '</a>';

    }
    document.getElementById("player_selector").innerHTML = newText;
}
/*
...
function switchPlayers(playerNum) {
    ...
    var avgPassYards = parseInt(players[playerNum].pass_yards / players[playerNum].games_played);
    document.getElementById("avg_p_yards").innerHTML = avgPassYards;
    var avgRushYards = parseInt(players[playerNum].rushing_yards / players[playerNum].games_played);
    document.getElementById("avg_r_yards").innerHTML = avgRushYards;
    var avgRecYards = parseInt(players[playerNum].receiving_yards / players[playerNum].games_played);
